...
public class Locators {
    ...
    public static final By ONLY_VIDEOS_BUTTON = By.xpath("//div[@id='chip-container']//*[@id='text' and contains(text(), 'Vídeos')]");
    public static final By FILTER_BUTTON = By.xpath("//div[@id='filter-button']");
    public static final By ONLY_VIDEOS_FILTER_BUTTON = By.xpath("//div[@id='label' and @title='Buscar Vídeo']");
